            ...
            <div>
              <div className="grid gap-4">
                {contacts.map(({ icon: Icon, label, info }) => (
                  <div
                    key={label}
                    className="flex justify-between items-center bg-[#f5f5f5]  rounded-2xl p-4"
                  >
            ...
            <form className="space-y-8">
                ...
                {inputs.map(({ id, label, type, placeholder }) => (
                  ...
                  >
                    <div className="flex flex-col space-y-2">
                      <label
                        htmlFor={id}
                        className="font-bold text-xs roboto tracking-wide"
                      >
                        {label}
                      </label>
                      <input
              ...
              <div className="flex flex-col space-y-2">
                ...
                <input
                  ...
                  name="attach"
                  required
                  className="py-2.5 px-4 rounded-lg bg-white text-sm h-30 border border-light-border/30"
                />
              </div>
