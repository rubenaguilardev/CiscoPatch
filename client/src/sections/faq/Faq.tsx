    ...
    <section id='faq' className="py-32 overflow-hidden w-full ">
      <div className="container space-y-4 mx-auto px-4 md:px-6 relative">
        <div className="bg-foreground p-8 rounded-2xl bg-[url('/faq-bg.png')] bg-no-repeat bg-bottom-right">
          ...
          <button className='absolute top-[58%] left-[52%] text-white text-sm font-bold bg-primary rounded-full py-12 px-4 border-14 border-white cursor-pointer'>Get Estimate</button>
        </div>
